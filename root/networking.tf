...
# Email authentication records for practice-music.io
resource "digitalocean_record" "spf_record_practice_music" {
  domain = digitalocean_domain.practice-music.id
  type   = "TXT"
  name   = "@"
  value  = "v=spf1 include:_spf.google.com include:sendgrid.net ~all"
...
resource "digitalocean_record" "google_domainkey_practice_music" {
  domain = digitalocean_domain.practice-music.id
  type   = "TXT"
  name   = "google._domainkey"
  value  = "v=DKIM1; k=rsa; p="
